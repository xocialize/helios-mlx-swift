...
| **S3** AR loop | DMD pyramid scheduler (`scheduler.py`) + 33-frame-chunk generation w/ rolling history + spatial 1/4-res pyramid; per-chunk parity then full e2e vs PR#21 `generate_helios.py`. |
